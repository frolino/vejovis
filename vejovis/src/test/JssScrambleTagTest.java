...
public class JssScrambleTagTest {
	...
	static final String INJECTIONSFOLDER = "jssScrambleTagInjections/";
	...
	public static void main(String[] args) {
		...
		File file = new File("/jssScrambleInjections/results_tag-7.txt");
